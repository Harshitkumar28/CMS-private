...
import banner from "../assets/img/7922058.jpg";

function About() {
  const submitHandler = (event) => {
    event.preventDefault();
    alert('Your message has been conveyed successfully. Thank You!');
        ...
        <div className="container py-4">
          <div className="row align-items-center justify-content-between">
            <div className="contact-header col-lg-4">
                ...
                <h3 className="mt-3 regular-400">We are waiting to hear you!</h3>
              ...
              <figure className="td_figure">
                <img src={banner} alt="banner"
                 style={{
                  ...
                  width: '80%',    // Make the image take the not the full width of its container
                }}
                />
              </figure>
            </div>
          ...
          <div className="col-lg-4">
            ...
            <div className="contact row mb-4">
              ...
              <ul className="contact-info list-unstyled col-lg-9 col-9 light-300">
                ...
                <li className="text-muted">Silchar Assam</li>
                <li className="text-muted">India</li>
              </ul>
            </div>
          </div>
          <div className="col-lg-8 ">
            <form className="contact_form row" method="post" action="#" onSubmit={submitHandler}>
